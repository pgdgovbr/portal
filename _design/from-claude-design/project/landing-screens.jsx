...
// ═══════════════════════════════════════════════════════════════════════
// HeroScreenAIRewrite · embute o ScreenRegistrar do app com painel IA
// no estado "previewing" — vira a "estrela" do hero.
// Escala automática para caber no browser frame de ~640px de largura.
// ═══════════════════════════════════════════════════════════════════════
...
<div style={{
  ...
  pointerEvents: "none"
    ...
    <ScreenRegistrar density="confortavel" aiInitialState="editing" />
  </div>;
