  ...
  return (
    <div id="top" className="lp" data-screen-label="Landing Mobile · pública v2" style={{
      ...
      <section style={{ padding: "32px 20px 28px" }}>
        ...
        {/* Screenshot mobile (PárcIA-style preview) */}
        <div className="lp-browser" style={{ borderRadius: 14 }}>
          <div className="lp-browser-bar" style={{ padding: "9px 12px" }}>
            <span className="lp-browser-dot" style={{ background: "#FF5F57", width: 9, height: 9 }} />
            <span className="lp-browser-dot" style={{ background: "#FEBC2E", width: 9, height: 9 }} />
            <span className="lp-browser-dot" style={{ background: "#28C840", width: 9, height: 9 }} />
            <span className="lp-browser-url" style={{ fontSize: 11, maxWidth: "100%" }}>
              <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" style={{ color: "var(--c-success)" }}><rect x="3" y="11" width="18" height="11" rx="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>
              pgd.gov.br
            </span>
          </div>
          <img src="screenshots/mobile-servidor.png" alt="Tela do servidor no PGD Livre" style={{ width: "100%", display: "block" }} />
        </div>
        ...
        <div style={{ marginTop: 14, display: "flex", flexWrap: "wrap", gap: 8 }}>
          ...
          <span className="lp-chip" style={{ fontSize: 10.5 }}>API PGD Central</span>
          <span className="lp-chip" style={{ fontSize: 10.5 }}>Gov.br</span>
        </div>
      </section>
